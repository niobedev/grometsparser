---
original_url: https://www.dollstories.net/storiesad/dolly_case.html
...
Henrietta smiled once more, then closed the doors to the case. Each door closed with a loud Click, which she knew, because she had constructed them, meant they were closed with an electronic lock which was only controlled by the computer in the base of the case. Once it was set, and Henrietta would set it, it would not open until certain criteria were met, including any timer, or environmental conditions. The fixings holding her onto the frame were similarly designed to be released only under the command of the system beneath her.
