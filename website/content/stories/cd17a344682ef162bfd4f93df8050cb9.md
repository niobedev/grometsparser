---
original_url: https://grometsplaza.net/world/machine/storiesek/keg.html
...
Hello, I am Melodie, I am working for a consulting firm. I used to be an engineer for manufacturing companies in the past but with my luck, I was packed and shipped twice as finish product (see [curtainfactory](../storiesad/curtainfactory.html) and [bottlingproblems](../storiesad/bottlingproblems.html)). That is not counting the time I was washed while working as a maid to pay my tuition fee (see [washed](../storiessz/washed.html)). I now work in an office designing fabrication line. It is more 9 to 5 routine than before but the pay is better and most importantly, it is a lot safer, what could go wrong in an office? Installation was supervised by a field engineer.
